...
const ProductCard = ({ product }) => {
  return (
    <>
      <div className='bg-gray-900 rounded-2xl shadow-xl overflow-hidden flex flex-col h-full 
    transition duration-500 transform border border-gray-800 group hover:scale-[1.03] hover:shadow-orange-900/40'>
       ...
       <p className='text-gray-400 text-sm mb-4 line-clamp-4'>{product.description}</p>
       
       <div className='flex item-center text-xs text-gray-500'>
